...
// Returns the private 'App\Repository\RacketRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/RacketRepository.php';

return $this->privates['App\\Repository\\RacketRepository'] = new \App\Repository\RacketRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
