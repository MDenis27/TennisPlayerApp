...
// Returns the private 'App\Repository\TennisStringRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/TennisStringRepository.php';

return $this->privates['App\\Repository\\TennisStringRepository'] = new \App\Repository\TennisStringRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
